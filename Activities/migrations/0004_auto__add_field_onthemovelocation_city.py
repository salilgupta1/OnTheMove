...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnthemoveLocation.city'
        db.add_column(u'Activities_onthemovelocation', 'city',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnthemoveLocation.city'
        db.delete_column(u'Activities_onthemovelocation', 'city')
