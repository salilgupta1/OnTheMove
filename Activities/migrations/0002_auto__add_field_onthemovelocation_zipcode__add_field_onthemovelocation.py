...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnthemoveLocation.zipcode'
        db.add_column(u'Activities_onthemovelocation', 'zipcode',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'OnthemoveLocation.address'
        db.add_column(u'Activities_onthemovelocation', 'address',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'OnthemoveLocation.state'
        db.add_column(u'Activities_onthemovelocation', 'state',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'OnthemoveLocation.country'
        db.add_column(u'Activities_onthemovelocation', 'country',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnthemoveLocation.zipcode'
        db.delete_column(u'Activities_onthemovelocation', 'zipcode')

        # Deleting field 'OnthemoveLocation.address'
        db.delete_column(u'Activities_onthemovelocation', 'address')

        # Deleting field 'OnthemoveLocation.state'
        db.delete_column(u'Activities_onthemovelocation', 'state')

        # Deleting field 'OnthemoveLocation.country'
        db.delete_column(u'Activities_onthemovelocation', 'country')
