...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OnthemoveActivity'
        db.create_table(u'Activities_onthemoveactivity', (
            ('activity_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity_name', self.gf('django.db.models.fields.TextField')(max_length=40)),
            ('start_time', self.gf('django.db.models.fields.TimeField')()),
            ('end_time', self.gf('django.db.models.fields.TimeField')(null=True)),
            ('location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Activities.OnthemoveLocation'])),
            ('activity_img', self.gf('django.db.models.fields.files.ImageField')(default='static/Activities/img/activity/default_act.jpg', max_length=100)),
            ('min_num_attendees', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('max_num_attendees', self.gf('django.db.models.fields.IntegerField')()),
            ('owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Users.OnthemoveUser'])),
            ('skill_level', self.gf('django.db.models.fields.TextField')(default='Beginner', max_length=2)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('is_closed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Activities', ['OnthemoveActivity'])

        # Adding model 'OnthemoveLocation'
        db.create_table(u'Activities_onthemovelocation', (
            ('location_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location_name', self.gf('django.db.models.fields.TextField')(max_length=100)),
            ('location_img', self.gf('django.db.models.fields.files.ImageField')(default='static/Activities/img/locations/default_loc.jpg', max_length=100)),
            ('location_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1)),
            ('longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'Activities', ['OnthemoveLocation'])


    def backwards(self, orm):
        # Deleting model 'OnthemoveActivity'
        db.delete_table(u'Activities_onthemoveactivity')

        # Deleting model 'OnthemoveLocation'
        db.delete_table(u'Activities_onthemovelocation')
    ...
    models = {
        u'Activities.onthemoveactivity': {
            ...
            'owner_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Users.OnthemoveUser']"}),
