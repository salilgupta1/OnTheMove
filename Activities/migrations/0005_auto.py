...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field pending on 'OnthemoveActivity'
        m2m_table_name = db.shorten_name(u'Activities_onthemoveactivity_pending')
    ...
    def backwards(self, orm):
        # Removing M2M table for field pending on 'OnthemoveActivity'
        db.delete_table(db.shorten_name(u'Activities_onthemoveactivity_pending'))
