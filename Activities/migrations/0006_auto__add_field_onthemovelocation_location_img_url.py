...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnthemoveLocation.location_img_url'
        db.add_column(u'Activities_onthemovelocation', 'location_img_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnthemoveLocation.location_img_url'
        db.delete_column(u'Activities_onthemovelocation', 'location_img_url')
    ...
    models = {
        ...
        u'Activities.onthemovelocation': {
            ...
            'city': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            ...
            'location_img_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'location_name': ('django.db.models.fields.TextField', [], {'max_length': '100'}),
            'location_rate': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '2', 'decimal_places': '1'}),
        ...
        u'Users.onthemoveuser': {
            ...
            'phoneNumber': ('localflavor.us.models.PhoneNumberField', [], {'max_length': '20', 'blank': 'True'}),
