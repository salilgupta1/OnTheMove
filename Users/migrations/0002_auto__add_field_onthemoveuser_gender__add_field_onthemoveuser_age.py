...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnthemoveUser.gender'
        db.add_column(u'Users_onthemoveuser', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='NA', max_length=2),
                      keep_default=False)

        # Adding field 'OnthemoveUser.age'
        db.add_column(u'Users_onthemoveuser', 'age',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnthemoveUser.gender'
        db.delete_column(u'Users_onthemoveuser', 'gender')

        # Deleting field 'OnthemoveUser.age'
        db.delete_column(u'Users_onthemoveuser', 'age')
